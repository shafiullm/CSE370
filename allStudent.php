...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM student_info where S_id = '" . $id . "'";
  ...
  <div class="d-flex" id="wrapper">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a href="pending.php"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Pending Applications</a>
        </li>
        <li>
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td> <?php echo $output[$i]['Credit'] ?> </td>
                          <td><?php echo $output[$i]['CGPA'] ?></td>
                          <form method="post">
